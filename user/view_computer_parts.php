    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-10">
                    <div class="text-center p-2">
                        <!-- Product Image -->
                        <img src="../assets/image/computer_parts_image/<?php echo $product['image']; ?>" alt="Product Image" class="image-fluid border shadow fixed-height-image">
                    </div>
                </div>
                <div class="col-lg-6 col-sm-10">
                    <!-- Product Details -->
                    <h2><?php echo $product['parts_name']; ?></h2>
                    ...
                    <div class="ms-3">
                        <?php
                            if (!empty($_SESSION['email'])) {
                                ?>
                                    <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#add_parts_modal<?php echo $id; ?>">Add to Cart</button>
                                <?php
                            } else {
                                ?>
                        ...
                        <?php
                            ...
                            $reviewPackageName = $product['parts_name'];
            ...
            <div class="row">
                ...
                <?php
                    $sql1 = "SELECT * FROM computer_parts WHERE id != $id";
                            ...
                            <div class="col-lg-3">
                                <div class="card m-2">
                                    ...
                                    <div class="position-relative overflow-hidden d-flex justify-content-center align-items-center" style="height: 200px;">
                                        <img 
                                            src="../assets/image/computer_parts_image/<?php echo $row1['image']; ?>" 
                                            alt="Product Image" 
                                        ...
                                        <div class="position-absolute top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center bg-dark bg-opacity-50 opacity-0 hover-overlay">
                                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_parts_modal<?php echo $id; ?>">Add to Cart</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <a class="nav-link" href="view_computer_parts.php?id=<?php echo $row1['id']; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="product_buy_now_label"><?php echo $product['parts_name']; ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="text-center">
                    <img src="../assets/image/computer_parts_image/<?php echo $product['image']; ?>" alt="Parts Image" class="img-fluid mb-3 p-2 border shadow" style="max-height: 200px;">
                </div>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" id="confirmPurchaseLink" href="confirm_parts_purchase.php?id=<?php echo $product['id']; ?>&quantity=1">Confirm Purchase</a>
            </div>
        </div>
    </div>
</div>
