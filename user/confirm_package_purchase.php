...
<html lang="en">
    ...
    <body>
            ...
            if($result) {
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="container mb-3">
                        <div class="row border rounded p-2">
                            <div class="col-lg-2">
                                <img src="../assets/image/package_image/<?php echo $row['package_image']; ?>" alt="">
                            </div>
                            <div class="col">
                                <h4><?php echo $row['package_name']; ?></h4>
                                <span class="me-5">Price: <?php echo $row['package_price']; ?></span>
             ...
             if($result) {
                 while($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="row border rounded p-2">
                        ...
                        <span>Price:  &#8369;<?php echo $row['package_price'];?></span>
                        <span>Quantity: <?php echo $stock;;?></span>
                        <span>Total:  &#8369;<?php echo $row['package_price']*$stock;?></span>
                    </div>
                <?php
                    }
                }
        ...
        <div class="container">
                <form action="../assets/php_script/purchase_package_script.php?email=<?php echo $email; ?>&id=<?php echo $id; ?>&quantity=<?php echo $stock; ?>&mop=" 
