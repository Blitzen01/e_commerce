        ...
        <body>
            ...
            <div class="chatbox" id="chatbox">
                ...
                <div class="chatbox_container" id="chatboxContainer">
                    ...
                    <!-- Example of admin's response -->
                    <div class="admin_message">
                        <p>Admin: Hi! How can I help you today?</p>
                    </div>
                    <div class="user_message">
                        <p>User: Hi! How can I help you today?</p>
                    </div>
                </div>
                ...
                <form action="" method="post">
                    <div class="input-group mx-auto">
                        <input type="text" class="form-control" id="userMessage" autocomplete="off" placeholder="Type your message here">
